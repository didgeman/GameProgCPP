...
const Vector3 Vector3::Infinity(MadMath::Infinity, MadMath::Infinity, MadMath::Infinity);
const Vector3 Vector3::NegInfinity(MadMath::NegInfinity, MadMath::NegInfinity, MadMath::NegInfinity);
...
Vector3 Vector3::TransformWithPerspDiv(const Vector3& vec, const Matrix4& mat, float w /*= 1.0f*/)
{
	...
	if (!MadMath::NearZero(MadMath::Abs(transformedW)))
	{
